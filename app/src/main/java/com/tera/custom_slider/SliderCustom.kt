...
typealias OnValueListener = (value: Float) -> Unit
...
class SliderCustom(
    ...
    var valueListener: OnValueListener? = null
    ...
    private fun drawTracActive(canvas: Canvas) {
        ...
        val y2 = mTrackBottom
        val x1 = mOffset
        val x2 = mOffset + mLenActive //- mMin * mRatio
        val r = mTrackRadius
